...
export default function KnowledgeGraphPreview() {
  return (
    <div className="card w-full inner-glow relative overflow-hidden group">
      {/* Decorative background representing a graph */}
      ...
      <div className="card-body relative z-10 space-y-3">
        ...
        <Link to="/graph" className="btn-secondary w-full justify-center group-hover:border-primary/50 group-hover:bg-surface-light transition-all">
